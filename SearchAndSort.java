...
/**
 * the search and sort class contains several sorting algorithms, and can create
 * a list of random integers and sort them in a variety of ways. the code uses 
 * several classes imported from other users, as java has a wide range of 
 * prexisiting code for all to use and build off of. this project was helpful 
 * for me to understand more about the java language and coding as a whole,
 * from simple things like camelCase to more advanced aspects like nested for 
 * loops. Furthermore this project is great for understanding how a computer 
 * operates, and really helped me learn how indexes worked, something that 
